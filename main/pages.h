...
<head><title>ESP32 NAT Router/Secure Broker/Client App</title></head>\
...
document.body.innerHTML ='<h1>ESP32 NAT Router/Secure Broker Config</h1>The new settings have been sent to the device.<br/>The page will refresh soon automatically...';\
...
<tr>\
<td>SSID</td>\
<td><input type='text' name='ap_ssid' value='%s' placeholder='SSID of created WIFI'/></td>\
</tr>\
<tr>\
<td>Password</td>\
<td><input type='text' name='ap_password' value='%s' placeholder='Password of created WIFI'/></td>\
</tr>\
<tr>\
<td></td>\
